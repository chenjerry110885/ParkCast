/**
 * The app's icon set: eighteen inline SVGs, one stroke drawing each on a
...
/** 機車: two wheels, a deck and a handlebar. Not a car, at a glance, which is the whole job. */
export const Scooter = (p: IconProps) => <Icon {...p}><circle cx="6" cy="17" r="3" /><circle cx="18" cy="17" r="3" /><path d="M9 17h6M15 17l-2-8h-2M13 9h4l2 8M4 9h4" /></Icon>;
/** 充電: the two-pin plug every charging bay in Taipei is signed with. */
export const Charging = (p: IconProps) => <Icon {...p}><path d="M9 3v5M15 3v5M7 8h10v3a5 5 0 0 1-10 0V8ZM12 16v5" /></Icon>;
